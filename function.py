...
#             print("the deposited amount is",deposit,"and the final balance is",self.balance)
#     def withdraw(self):
...
# class temperature():
#     def __init__(self,faranheit,celcius):
...
#                x=studentclass(name,rollnumber,newage)
#                l.append(x)
...
#        x=studentclass(name,rollnumber,age)
#        l.append(x)
#     elif n==2:
#         search=str(input('enter the name of student='))
#         for i in l:
#             if i.name==search:
#               i.display()
#             else:
#                 print("enter the enrolled student name")
#     elif n==3:
